...
DOCUMENTATION = r"""
---
module: d42_api_certificates_info
short_description: Get Device42 certificates
description:
    - Retrieve certificates added or discovered in Device42.
    - Supports optional filter on C(certificate_id) for C(/api/1.0/certificates/).
version_added: "0.2.0"
author:
...
EXAMPLES = r"""
- name: Get all Device42 certificates
    xbh03.device42.certificates.d42_api_certificates_info:
        host: device42.example.internal
        client_key: abc123
        client_secret_key: secret123

- name: Get specific Device42 certificate by ID
    xbh03.device42.certificates.d42_api_certificates_info:
        host: device42.example.internal
        client_key: abc123
        client_secret_key: secret123
...
RETURN = r"""
api_certificates:
    description: Raw response from Device42 certificates endpoint.
    type: dict
    returned: success
    sample: |
        total_count: "1"
...
def run_module():
        ...
        result["api_certificates"] = helper.d42_get_certificates(
